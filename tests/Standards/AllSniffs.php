...
if ($standard !== 'Generic' && $standard !== 'PEAR' && $standard !== 'PSR1' && $standard !== 'PSR2' && $standard !== 'Zend') continue;
                ...
                foreach ($di as $file) {
                    ...
                    $className = str_replace($path.DIRECTORY_SEPARATOR, 'PHP_CodeSniffer\Standards\\', $filePath);
