<?php
/**
 * Tests for the PHP_CodeSniffer_File:findFirstOnLine method.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Core_File_FindFirstOnLineTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testSpecificValue()
    {
        ...
        $found = $this->_phpcsFile->findFirstOnLine(
            T_STRING,
            $comment - 2,
            false,
            'stripos'
...
$pos = stripos($string, $part); /* testSpecificValue */
