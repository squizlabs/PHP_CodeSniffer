<?php
/**
 * Tests for the PHP_CodeSniffer_File:findNext method.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Core_File_FindNextTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testSpecificValue()
    {
        ...
        $found = $this->_phpcsFile->findNext(
            T_STRING,
            $comment + 2,
            null,
            false,
...
/* testSpecificValue */ $pos = stripos($string, $part);
/* testInArrayValue */ $pos = stripos($string, $part);
