...
class LocalFile
{
     ...
     * @var array()
     */
    private static $ignoredLines = array();
     ...
     * @var array()
     */
    private $ignoredListeners = array();
...
/*
    ...
    public function process()
    {
        ...
        try {
            $this->eolChar = Util\Common::detectLineEndings($this->path, $this->content);
            ...
            if ($token['code'] === T_COMMENT
                ...
                if (strpos($token['content'], '@codingStandards') !== false) {
                    if (strpos($token['content'], '@codingStandardsIgnoreFile') !== false) {
                        ...
                        $listenerClass = 'PHP_CodeSniffer\Standard\\'.$sniffParts[1].'\\'.$sniffParts[2].'Sniff';
...
*/
    ...
    {
        if (isset(self::$ignoredLines[$line]) === true) {
            return false;
        }
    ...
    public function getDeclarationName($stackPtr)
    {
        ...
        if ($tokenCode !== T_FUNCTION
            ...
            throw new PHP_CodeSniffer_Exception('Token type "'.$this->tokens[$stackPtr]['type'].'" is not T_FUNCTION, T_CLASS, T_INTERFACE or T_TRAIT');
        }
