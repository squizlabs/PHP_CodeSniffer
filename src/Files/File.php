...
class File
{
     ...
     *
     * @deprecated 3.5.0 Use PHP_CodeSniffer\Util\Sniffs\FunctionDeclarations::getParameters() instead.
     */
    public function getMethodParameters($stackPtr)
    {
        return Util\Sniffs\FunctionDeclarations::getParameters($this, $stackPtr);
     ...
     *                                                      T_FUNCTION token.
     *
     * @deprecated 3.5.0 Use PHP_CodeSniffer\Util\Sniffs\FunctionDeclarations::getProperties() instead.
     */
    public function getMethodProperties($stackPtr)
    {
        return Util\Sniffs\FunctionDeclarations::getProperties($this, $stackPtr);
