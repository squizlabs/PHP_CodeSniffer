            ...
            */
            ...
            if ($tokenIsArray === true
                ...
                if (isset($this->tstringContexts[$finalTokens[$lastNotEmptyToken]['code']]) === false) {
                    ...
                    if (PHP_CODESNIFFER_VERBOSITY > 1) {
                        Common::printStatusMessage("* token $stackPtr changed from T_DEFAULT to T_STRING", 2);
                    }
                    ...
                    if (isset($tokens[$x]) === true
                        ...
                        for ($x; $x < $numTokens; $x++) {
                            if ((is_array($tokens[$x]) === false && $tokens[$x] !== '|')
                                ...
                                if (PHP_CODESNIFFER_VERBOSITY > 1) {
                                    Common::printStatusMessage("* token $x changed from T_ARRAY to T_STRING", 2);
                                }
                            }
                        }
                    }//end if
                ...
                */
                ...
                if ($this->tokens[$x]['code'] !== T_STRING) {
                    if (PHP_CODESNIFFER_VERBOSITY > 1) {
                        $line = $this->tokens[$x]['line'];
                        $type = $this->tokens[$x]['type'];
                        Common::printStatusMessage("* token $x on line $line changed from $type to T_STRING", 1);
                    }
